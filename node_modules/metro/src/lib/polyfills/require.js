...
function loadModuleImplementation(moduleId, module) {
  ...
  try {
    ...
    if (__DEV__) {
      _moduleObject.id = module.verboseName || _moduleObject.id;
...
if (__DEV__) {
  metroRequire.Systrace = { beginEvent: function beginEvent() {}, endEvent: function endEvent() {} };
  ...
  var metroAcceptAll = function metroAcceptAll(dependentModules, inverseDependencies, patchedModules) {
    ...
    var notAccepted = dependentModules.filter(function (module) {
      return !metroAccept(module,
      /*factory*/undefined,
      /*dependencyMap*/undefined, inverseDependencies, patchedModules);
    });
